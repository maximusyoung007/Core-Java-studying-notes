...
public class IndexInterceptor1 extends HandlerInterceptorAdapter{
	public boolean preHandle(HttpServletRequest request,
		...
		System.out.println("preHandle(), 在访问Controller之前被调用 1111"); 
        return true;
	}
	...
	public void postHandle(HttpServletRequest request,HttpServletResponse response,
		...
		+ "在访问Controller之后，访问视图之前被调用,这里可以注入一个时间到modelAndView中，用于后续视图显示1111");
	...
	public void afterCompletion(HttpServletRequest request,HttpServletResponse resopnse,
		...
		System.out.println("afterCompletion(), 在访问视图之后被调用1111"); 
	}
}
